<div class="container-detail">
  <div style="position:absolute;left:17%;top:35%;width:20%;min-width:300px;padding-top:10px;text-align:center;">
    <img style="width:100%;margin-bottom:10px;" src="./images/detail/bt.png"/>
  ...
  <div class="row" >
    <div class="col-xs-3" style="text-align:right;padding-top: 20px;">
       <h3 class="title">其他参数</h3>
    </div>
    <div class="col-xs-2" style="text-align:center;">
      <div class="detail">
        <div>产品附件</div>
        <div style="margin-top:90px;">电源</div>
      </div>
    </div>
